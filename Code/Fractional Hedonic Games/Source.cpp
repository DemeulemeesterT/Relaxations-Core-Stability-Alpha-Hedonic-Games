...
int main()
{
	...
	std::vector<int> n_vector{7}; // Number of agents in blocking coalition
	
	std::vector<int> q_vector{3};	// Values for q-size core stability
	...
	std::vector<double> c_vector{3}; //values for c-improvement core stability 
